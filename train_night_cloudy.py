...
def main():
    ...
    plt.ylabel("Loss")
    plt.legend()
    plt.savefig(config.MODEL_DIR_NC + "/CycleLossTrainNC.jpg", bbox_inches = 'tight')
    ...
    plt.ylabel("Loss")
    plt.legend()
    plt.savefig(config.MODEL_DIR_NC + "/CycleLossValNC.jpg", bbox_inches = 'tight')
    ...
    plt.ylabel("D_Loss")
    plt.legend()
    plt.savefig(config.MODEL_DIR_NC + "/D_loss_NC.jpg", bbox_inches='tight')
    plt.show()
